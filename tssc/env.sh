...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/dotnet-basic-pjsbausf:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/dotnet-basic-pjsbausf-gitops
